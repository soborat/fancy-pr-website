...
function CookiePolicy() {
  return (
    <>
      <Head>
        <title>Enterprwise - Cookie Policy</title>
        <meta
          name="description"
          content="We use cookies to help improve your experience of enterprwise.com"
        ></meta>
      </Head>
      <Container>
        ...
        <Typography>
          ...
          https://www.enterprwise.com. This cookie policy is part of Digital
          Rats Solutions&apos; privacy policy, and covers the use of cookies
          between your device and our site. We also provide basic information on
          third-party services we may use, who may also use cookies as part of
          their service, though they are not covered by our policy.
          <br /> <br />
          If you don&apos;t wish to accept cookies from us, you should instruct
          your browser to refuse cookies from https://www.enterprwise.com, with
      ...
      <Container>
        ...
        <Typography>
          ...
          cookies may be set by the website you&apos;re visiting (first-party)
        ...
        <Typography>
          ...
          they are not covered by @&apos; cookie policy.
        </Typography>
      </Container>
      <Container>
        <Typography variant="h3">Our third-party privacy promise</Typography>
        <Typography>
          We may employ third-party companies and individuals on our
          websites—for example, analytics providers and content partners. We
          grant these third parties access to selected information to perform
